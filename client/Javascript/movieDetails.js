      ...
      quoteHTML = `
                <div class="quoted-comment">
                    <div class="user-info">
                        ...
                        <div>
                            <span class="username">${
                              comment.quotedComment.username
                            }</span>
            ...
            <div class="comment-content">
                ...
                <div class="comment-actions">
                    <div class="like-dislike">
                        <span class="like-button" data-comment-id="${
                          comment.commentId
                        }">
                        ...
                        <span class="dislike-button" data-comment-id="${
                          comment.commentId
                        }">
...
async function likeComment(commentId) {
  if (!token) {
    console.error(
      "Authentication token not found. User must be logged in to like."
    );
    return;
  }
...
async function dislikeComment(commentId) {
  if (!token) {
    console.error(
      "Authentication token not found. User must be logged in to dislike."
    );
    return;
  }
